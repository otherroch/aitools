...
| Video Description | `videsc` | Generate text descriptions for video files — fast WD14 tag-based captions (default) or rich natural-language descriptions via Qwen3-VL / Qwen3-omni / Qwen3.5 / Qwen3.6   (`--vl`) or Gemma4 (`--gemma4`) |
...
- [videsc](doc/VIDESC.md) — video description generator (WD14 tags, Qwen3-VL, Qwen3-omni, Qwen3.5, Qwen3.6, Gemma4) natural language)
